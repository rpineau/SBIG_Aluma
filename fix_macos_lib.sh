#!/bin/zsh
install_name_tool -change  @rpath/libdlapi.2.dylib /usr/local/lib/libdlapi.2.dylib /Applications/Astronomy/TheSkyX\ Professional\ Edition.app/Contents/PlugIns/CameraPlugIns/libSBIG_Aluma.dylib
